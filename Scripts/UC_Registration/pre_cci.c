# 1 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c"
...
# 1 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2
...
# 2 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2
...
# 3 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2
...
# 4 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2

# 1 "Action.c" 1
Action()
{
	
	lr_start_transaction("UC_Registration");

	web_set_sockets_option("SSL_VERSION", "AUTO");

	web_set_user("{c1}{c2}{c3}{c4}{c5}{c6}", 
	...
	lr_end_transaction("clickUser",2);
	...
	web_reg_find("Text=New user created successfully.",
		"LAST");
	...
	web_custom_request("AccountCreateRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountCreateRequest xmlns=\"com.advantage.online.store.accountservice\"><accountType>USER</accountType><address>Moscow1</address><allowOffersPromotion>false</allowOffersPromotion><cityName>Moscow</cityName><countryId>Russia,ru</countryId><email>{c1}{c2}{c3}{c4}{c5}{c6}@User23.com</"
		"email><firstName>{c1}{c2}{c3}{c4}{c5}{c6}Firstname</firstName><lastName>{c1}{c2}{c3}{c4}{c5}{c6}Lastname</lastName><loginName>{c1}{c2}{c3}{c4}{c5}{c6}</loginName><password>{c1}{c2}{c3}{c4}{c5}{c6}</password><phoneNumber>1234567</phoneNumber><stateProvince>Moscow</stateProvince><zipcode>123456</zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	web_custom_request("AccountLoginRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLoginRequest xmlns=\"com.advantage.online.store.accountservice\"><email>{c1}{c2}{c3}{c4}{c5}{c6}@User23.com</email><loginPassword>{c1}{c2}{c3}{c4}{c5}{c6}</loginPassword><loginUser>{c1}{c2}{c3}{c4}{c5}{c6}</loginUser></AccountLoginRequest></soap:Body></soap:Envelope>", 
		"LAST");
	...
	lr_end_transaction("feelUserData",2);
	...
	lr_end_transaction("clickEditUser",2);
	...
	lr_end_transaction("clickEditPaymentMethod",2);
	...
	web_custom_request("AddSafePayMethodRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AddSafePayMethodRequest xmlns=\"com.advantage.online.store.accountservice\"><safePayUsername>{c1}{c2}{c3}{c4}{c5}{c6}</safePayUsername><accountId>611849985</accountId><safePayPassword>{c1}{c2}{c3}{c4}{c5}{c6}1</safePayPassword><base64Token>Basic VXNlcjIzOlVzZXIyMw==</base64Token></"
	...
	lr_end_transaction("SafePayData",2);
	...
	lr_end_transaction("UC_Registration", 2);

	return 0;
}
# 5 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2
...
# 6 "c:\\users\\ehot\\desktop\\itog\\scripts\\uc_registration\\\\combined_UC_Registration.c" 2
