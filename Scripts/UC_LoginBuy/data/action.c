Action()
{
	...
	web_custom_request("AccountLoginRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLoginRequest xmlns=\"com.advantage.online.store.accountservice\"><email></email><loginPassword>User11</loginPassword><loginUser>User11</loginUser></AccountLoginRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_url("582186139", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/carts/582186139", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
	...
	web_submit_data("DD3A5B", 
		"Action=https://www.advantageonlineshopping.com/order/api/v1/carts/582186139/product/30/color/DD3A5B?quantity=1", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=sessionId", "Value=29B88EF3D0FB10DF44720BB4B5ACCB12", ENDITEM, 
		LAST);
	...
	web_custom_request("shippingcost", 
		...
		"Body={\"seaddress\":{\"addressLine1\":\"Moscow1\",\"addressLine2\":\"\",\"city\":\"Moscow\",\"country\":\"sm\",\"postalCode\":123456,\"state\":\"Moscow\"},\"secustomerName\":\"User11first User11last\",\"secustomerPhone\":1234567,\"senumberOfProducts\":1,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"29B88EF3D0FB10DF44720BB4B5ACCB12\"}", 
		LAST);
